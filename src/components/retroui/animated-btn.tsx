...
const AnimatedBtn = ({ children, href = '/' }: AnimatedBtnProps) => {
  return (
    ...
    >
      <button className=" z-9999999  w-[170px] rounded-full  bg-primary text-white   leading-10 text-center no-underline pl-5 transition-transform duration-200 ease-in-out hover:scale-105 ">
        {children}
      </button>
      <img
