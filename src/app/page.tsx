  ...
  return (
    <BaseLayout>
      <section className="w-full  md:max-w-360 md:justify-between flex flex-col md:flex-row gap-6  px-4">
        <section className=" max-w-96 max-h-[30rem] old-scrollbar bg-[#b1aea1]/20 border-[#b1aea1] border  overflow-y-scroll flex flex-col items-center gap-4 old-scrollbar p-2">
